        ...
        return (
            <div>
                ...
                <table className="mdl-data-table mdl-js-data-table mdl-data-table--selectable mdc-elevation--z1" style={{ minWidth: "90%" }}>
                    <thead>
                        <tr>
                            {["SUPER_USER", "ADMIN"].includes(AuthModel.userInfo.get("role")) && <th className="mdl-data-table__cell--non-numeric">User</th>}
                                ...
                                <tr>
                                    ...
                                    DevicesModel.data.length > 0 ? (
                                        DevicesModel.data.map((object) => (
                                            <tr key={object.id}>
                                                {["SUPER_USER", "ADMIN"].includes(AuthModel.userInfo.get("role"))&& <td className="mdl-data-table__cell--non-numeric font-weight-bold">{object.user.name}</td>}
