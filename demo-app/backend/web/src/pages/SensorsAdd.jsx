                    ...
                    <Row className="mb-1">
                        <Col md="6">
                            <div className="mdc-text-field mdc-text-field--textarea" style={{ width: "100%", display: "none" }}>
                                <textarea defaultValue='{ "type": "double" }' rows="4" id="sensors-add-mapping" name="mapping" onChange={this.form.handleChange} className="mdc-text-field__input" autoComplete="off" data-lpignore="true" style={{ display: "none" }}></textarea>
                                            ...
                                            (
                                                <div>
                                                    ...
                                                    <select name="schemaId" onChange={this.form.handleChange}>
                                                        ...
                                                        <option value="" key="">Select Schema</option>
                                                        {
